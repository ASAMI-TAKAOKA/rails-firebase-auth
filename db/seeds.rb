...
meal_categories = %w[main_dish side_dish soup]
meal_times = %w[break_fast lunch dinner]
dish_names = {
  'break_fast' => %w[フレンチトースト パンケーキ オムレツ すりりんご 小松菜バナナヨーグルト],
  'lunch' => %w[トマトリゾット サンドイッチ ナポリタン 豆腐ハンバーグ おやき],
  'dinner' => %w[白身魚の団子 ヒラメがゆ かぼちゃうどん 肉じゃが かぼちゃグラタン]
}
